...
class UnaryMinus(UnaryOperator):
    ...
    def _recursive_construct_jax_function(
        ...
        def the_jax_function(
            ...
            child_value = child_jax(parameters, one_row, the_draws)
            return -child_value
...
class MonteCarlo(UnaryOperator):
    ...
    def _recursive_construct_jax_function(
        ...
        vectorized_function = vmap(
            lambda parameters, row, draws: child_jax(parameters, row, draws),
            in_axes=(None, None, 0),
        )
        ...
        def the_jax_function(
            ...
            value_per_draw = vectorized_function(parameters, one_row, the_draws)
