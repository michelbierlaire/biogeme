...
def test_parameter_role_enum_values() -> None:
    ...
    assert ParameterRole.STRUCTURAL_INTERCEPT.value == 'structural_intercept'
...
def test_resolved_structural_equation_fields_preserved() -> None:
    ...
    systematic_part = ResolvedLinearCombination(
        intercept=ResolvedParameterRef(final_name='alpha_lv1'),
        terms=terms,
    )
    ...
    assert equation.systematic_part.intercept == ResolvedParameterRef(
        final_name='alpha_lv1'
    )
    assert equation.systematic_part.terms is terms
...
def test_resolved_structural_equation_accepts_none_sigma() -> None:
    equation = ResolvedStructuralEquation(
        ...
        systematic_part=ResolvedLinearCombination(
            intercept=ResolvedParameterRef(final_name='alpha_lv2'),
            terms=[],
        ),
        sigma=None,
        draw_name='omega_lv2',
...
def test_resolved_structural_equation_is_frozen_and_slotted() -> None:
    equation = ResolvedStructuralEquation(
        ...
        systematic_part=ResolvedLinearCombination(
            intercept=ResolvedParameterRef(final_name='alpha_lv'),
            terms=[],
        ),
        sigma=None,
        draw_name='omega',
