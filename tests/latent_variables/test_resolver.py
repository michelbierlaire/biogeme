...
def test_resolve_structural_parameters_builds_coefficients_and_sigmas() -> None:
...
def test_resolve_structural_equations_uses_draw_type_and_sigma_refs() -> None:
    ...
    assert [term.variable_name for term in eq.terms] == ["x1", "x2"]
    assert eq.terms[0].coefficient.final_name == "struct_LV1_x1"
