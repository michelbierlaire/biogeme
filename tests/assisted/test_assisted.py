...
class FakeSetElement:
    ...
    def __init__(self, element_id: str, objectives: list[float] | None = None):
        self.element_id = element_id
        self.objectives = objectives or [0.0, 0.0]
...
class FakePareto:
    ...
    def __init__(self, filename: str):
        ...
        # The real Pareto object also exposes these collections. They may be
        # empty, but the post-processing code normalizes all of them after
        # loading a Pareto file.
        self.considered = []
        self.removed = []
        self.invalid = []
...
class FakeSpecification:
    ...
    def get_element(self, multi_objectives) -> FakeSpecificationElement:  # type: ignore[override]
...
def test_pareto_post_processing_reestimate_calls_estimate_for_each_element(monkeypatch):
    ...
    class FakeBiogemeFromConfig:
        ...
        def estimate_or_load(self):
            self.estimate_calls.append(True)
            return f'RESULT_{self.config_id}_R'
