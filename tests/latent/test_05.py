...
coef_haveChildren = Beta(
    'coef_haveChildren', -0.027979246306050195, None, None, 0
)
coef_haveGA = Beta('coef_haveGA', -0.749193972835575, None, None, 0)
coef_highEducation = Beta(
    'coef_highEducation', -0.25961437893330336, None, None, 0
)
coef_individualHouse = Beta(
    'coef_individualHouse', -0.1162986643952338, None, None, 0
)
...
coef_moreThanOneBike = Beta(
    'coef_moreThanOneBike', -0.36347727873174407, None, None, 0
)
coef_moreThanOneCar = Beta(
    'coef_moreThanOneCar', 0.714788103177542, None, None, 0
)
...
SIGMA_STAR_Envir02 = Beta(
    'SIGMA_STAR_Envir02', 0.9202761776516004, None, None, 0
)
SIGMA_STAR_Envir03 = Beta(
    'SIGMA_STAR_Envir03', 0.8584143518703582, None, None, 0
)
SIGMA_STAR_Mobil11 = Beta(
    'SIGMA_STAR_Mobil11', 0.8969716757915364, None, None, 0
)
SIGMA_STAR_Mobil14 = Beta(
    'SIGMA_STAR_Mobil14', 0.7605962891050919, None, None, 0
)
SIGMA_STAR_Mobil16 = Beta(
    'SIGMA_STAR_Mobil16', 0.8732950988286952, None, None, 0
)
SIGMA_STAR_Mobil17 = Beta(
    'SIGMA_STAR_Mobil17', 0.8749250793400859, None, None, 0
)
...
BETA_WAITING_TIME = Beta(
    'BETA_WAITING_TIME', -0.04409308504170328, None, None, 0
)
