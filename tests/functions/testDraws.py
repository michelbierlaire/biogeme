...
class testDraws(unittest.TestCase):
    ...
    def test_userDefinedDraws(self):
        ...
        draws = dr.getLatinHypercubeDraws(sampleSize=3,numberOfDraws=10,symmetric=False,uniformNumbers=myUnif)
        r,c = draws.shape
    ...
    def test_halton(self):
        ...
        h = np.array([0.33333333, 0.66666667, 0.11111111, 0.44444444, 0.77777778,
        ...
        h = [0.33333333, 0.66666667, 0.11111111, 0.44444444, 0.77777778,
             0.22222222, 0.55555556, 0.88888889, 0.03703704, 0.37037037]
        diff = halton - h
        norm = np.linalg.norm(diff)
        self.assertAlmostEqual(norm,0,7)
    ...
    def test_antithetic(self):
        ...
        d = [0.5  , 0.25 , 0.75 , 0.125, 0.625, 0.5  , 0.75 , 0.25 , 0.875,
        0.375]
