...
class TestConfiguration(unittest.TestCase):
    def test_ctor(self):
        s11 = conf.SelectionTuple(controller='catalog1', selection='item1')
        s12 = conf.SelectionTuple(controller='catalog1', selection='item2')
        s21 = conf.SelectionTuple(controller='catalog2', selection='choice1')
        s22 = conf.SelectionTuple(controller='catalog2', selection='choice2')
