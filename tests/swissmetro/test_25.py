...
myRandomNumberGenerators = {'TRIANGULAR':(theTriangularGenerator,'Triangular distribution T(-1,0,1)')}
...
class test_25(unittest.TestCase):
    def testEstimation(self):
        ...
        self.assertAlmostEqual(results.data.logLike,-5309.388416582446,2)
