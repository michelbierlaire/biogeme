...
class TestRawBayesianResults(unittest.TestCase):
    ...
    def test_basic_properties(self):
        idata = make_idata(chains=3, draws=11, n_obs=9)
        ...
        self.assertEqual(r.number_of_observations, 9)

    # ---------- number_of_observations inference ----------
    def test_number_of_observations_from_observed_data(self):
        idata = make_idata(chains=1, draws=1, n_obs=17)
        r = RawBayesianResults(idata=idata, model_name="m")
        self.assertEqual(r.number_of_observations, 17)

    def test_number_of_observations_when_observed_missing(self):
        # InferenceData without observed_data -> expect 0
        alpha = xr.DataArray(
            np.random.randn(2, 3),
            dims=("chain", "draw"),
        ...
        r = RawBayesianResults(idata=idata, model_name="m")
        self.assertEqual(r.number_of_observations, 0)
    ...
    def test_save_and_load_round_trip(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            self.assertEqual(r2.random_seed, 2025)
    ...
    def test_load_file_without_meta_group_defaults(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            self.assertEqual(r2.number_of_observations, 4)
            ...
            self.assertIsNone(r2.random_seed)
    ...
    def test_save_with_non_json_serializable_metadata_graceful(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            self.assertEqual(r2.number_of_observations, 3)
