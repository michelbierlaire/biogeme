...
sigma_car_centric = Beta(f'{car_prefix}_sigma', 1.0, 0.0001, None, 0)

car_centric_attitude = DistributedParameter(
    ...
    + sigma_car_centric * Draws(f'{car_prefix}_error_term', 'NORMAL'),
)
...
sigma_urban_preference = Beta(f'{urban_prefix}_sigma', 1.0, 0.0001, None, 0)
urban_preference_attitude = DistributedParameter(
    ...
    + sigma_urban_preference * Draws(f'{urban_prefix}_error_term', 'NORMAL'),
)
