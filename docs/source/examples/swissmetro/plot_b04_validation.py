...
the_biogeme.model_name = 'b04_validation'
...
# %%
# We report the total log likelihood on the validation sample for each slice.
for slice in validation_results:
    print(
        f'Log likelihood for {slice.simulated_values.shape[0]} validation data: '
        f'{slice.simulated_values.iloc[:, 0].sum()}'
    )
