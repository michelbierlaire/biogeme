...
from numpy.lib.format import MAGIC_LEN
...
from docs.source.examples.swissmetro.m02 import ASC_TRAIN_MALE, ASC_CAR_MALE
...
ASC_TRAIN_catalog = ASC_TRAIN + ASC_TRAIN_MALE * MALE
ASC_CAR_catalog = ASC_CAR + ASC_CAR_MALE * MALE
