...
# Additional terms for the non monotonic model
# %
# Parameters to be estimated in mu_utilities
...
# %
# Definition of the mu_utilities
...
# %
# Group the mu_utilities into a dictionary, mapping the alternative id with the specification.
mu_utilities = {
    1: shopping_mu,
    2: socializing_mu,
    3: recreation_mu,
