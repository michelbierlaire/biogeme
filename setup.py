...
Since the use of pyproject.toml, I did not manage to import the file
cysetuptools.py. Therefore, i have explicitly included it in the
setup.py file. This is not clean, but I did not find another way.
