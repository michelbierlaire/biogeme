...
We investigate the model specifciation that involves the structural equations \req{eq:linearStructural} and the measurement equations \req{eq:measurement_latent} and \req{eq:discreteMeas-d}.
Using \req{eq:linearStructural} into  \req{eq:measurement_latent}, we obtain
\begin{equation}
  \begin{aligned}
...
Following the derivation \req{eq:discreteMeas-d}, the
