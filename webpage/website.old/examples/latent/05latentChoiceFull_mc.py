...
from biogeme.expressions import Beta, DefineVariable, log, \
    bioDraws, MonteCarlo, Elem, bioNormalCdf, exp
...
try:
    ...
    print('Run first the script 04latentChoiceSeq.py in order to generate the file '
          '04latentChoiceSeq.pickle.')
    sys.exit()
