...
sampleVariance_halton = MonteCarlo(integrand_halton * integrand_halton) - \
    simulatedI_halton * simulatedI_halton
stderr_halton = (sampleVariance_halton / R)**0.5
error_halton = simulatedI_halton - trueI

sampleVariance_halton13 = MonteCarlo(integrand_halton13 * integrand_halton13) - \
...
sampleVariance_mlhs = MonteCarlo(integrand_mlhs * integrand_mlhs) - \
...
print(f'Sample var.\t{results.iloc[0]["Sample variance   "]:.6g}\t'
...
print(f'Std error\t{results.iloc[0]["Std Error         "]:.6g}\t'
