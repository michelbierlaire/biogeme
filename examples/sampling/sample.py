...
partition_pure = (
    StratumTuple(subset=all_alternatives, sample_size=SAMPLE_SIZE),
)
...
partition_asian = (
    ...
    StratumTuple(
        subset=all_alternatives - asian, sample_size=SAMPLE_SIZE - half
    ),
)
...
partition_downtown = (
    ...
    StratumTuple(
        subset=all_alternatives - downtown, sample_size=SAMPLE_SIZE - half
    ),
)
