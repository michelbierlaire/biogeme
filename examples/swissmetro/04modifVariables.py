...
# is 0, the log of 1 is computed instead.
LOG_CAR_COST = DefineVariable('LOG_CAR_COST',
                              (CAR_CO_SCALED != 0) * log(CAR_CO_SCALED + 1 * (CAR_CO_SCALED == 0)),
                              database)
LOG_TRAIN_COST = DefineVariable('LOG_TRAIN_COST',
                                (TRAIN_COST_SCALED != 0) * log(TRAIN_COST_SCALED + \
                                                               1 * (TRAIN_COST_SCALED == 0)),
                                database)

LOG_SM_COST = DefineVariable('LOG_SM_COST',
                             (SM_COST_SCALED != 0) * log(SM_COST_SCALED + \
                                                         1 * (SM_COST_SCALED == 0)),
                             database)
