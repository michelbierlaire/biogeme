...
from biogeme.expressions import Beta, DefineVariable, RandomVariable, PanelLikelihoodTrajectory, Integrate, log
...
# Conditional to omega, the likelihood of one observation is
# given by the logit model (called the kernel)
obsprob = models.logit(V,av,CHOICE)

# Conditional to omega, the likelihood of all observations for
...
# The numerical integration of the Rao-Cramer variance-covariance
# matrix has numerical problems. Therefore, we rely on bootstrapping
