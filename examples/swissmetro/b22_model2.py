...
Model_2:
  ASC_CAR_catalog:GA_segment
  TRAIN_COST_catalog:log
...
ASC_CAR_catalog = ASC_CAR_GA_segmentation.segmented_beta()
ASC_TRAIN_catalog = ASC_TRAIN_GA_segmentation.segmented_beta()
...
TRAIN_TT_catalog = models.boxcox(TRAIN_TT_SCALED, ell_TT)
SM_TT_catalog = models.boxcox(SM_TT_SCALED, ell_TT)
CAR_TT_catalog = models.boxcox(CAR_TT_SCALED, ell_TT)

TRAIN_COST_catalog = logzero(TRAIN_COST_SCALED)
SM_COST_catalog = logzero(SM_COST_SCALED)
CAR_COST_catalog = logzero(CAR_CO_SCALED)
...
the_biogeme.modelName = 'b22_model2'
