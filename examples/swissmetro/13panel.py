...
:date: Sun Sep  8 18:55:38 2019
 ...
 Same as 12panel, where the starting values for the parameters are
 close to optimal.  Useful for a faster estimation of the model with a
 large number of draws.  Three alternatives: Train, Car and Swissmetro
 SP data
"""
