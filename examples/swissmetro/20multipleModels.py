...
log_V2 = ASC_SM + B_TIME * log(SM_TT_SCALED) + B_COST * SM_COST_SCALED
...
results = {}
for name, specification in catalog_of_expressions:
    biogeme = bio.BIOGEME(database, specification)
    biogeme.modelName = f'multi_{name}'
