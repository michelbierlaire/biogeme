...
:date: Mon Nov 28 18:52:43 2022

 Example of a cross-nested logit model with moneymetric utilities
...
V1 = MU * (ASC_TRAIN + B_TIME * TRAIN_TT_SCALED + B_COST * TRAIN_COST_SCALED)
V2 = MU * (ASC_SM + B_TIME * SM_TT_SCALED + B_COST * SM_COST_SCALED)
V3 = MU * (ASC_CAR + B_TIME * CAR_TT_SCALED + B_COST * CAR_CO_SCALED)
