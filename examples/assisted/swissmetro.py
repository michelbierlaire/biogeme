...
segmentations_cte = {'GA': (GA, {1: 'GA',
                                 0: 'noGA'}),
                     'gender': (MALE, {0: 'female',
                                       1: 'male'}),
                     'class': (FIRST, {0: 'secondClass',
                                       1: 'firstClass'}),
                     'luggage': (LUGGAGE, {0: 'noLugg',
                                           1: 'oneLugg',
                                           3: 'severalLugg'}),
                     'income': (INCOME, {1:'inc-under50',
                                         2: 'inc-50-100',
                                         3: 'inc-100+',
                                         4: 'inc-unknown'})}

segmentations_cost = {'GA': (GA, {1: 'GA',
                                  0: 'noGA'}),
                      'gender': (MALE, {0: 'female',
                                        1: 'male'}),
                      'income': (INCOME, {1:'inc-under50',
...
segmentations_headway = {'class': (FIRST, {0: 'secondClass',
                                           1: 'firstClass'}),
                         'luggage': (LUGGAGE, {0: 'noLugg',
                                               1: 'oneLugg',
                                               3: 'severalLugg'}),
...
segmentations = {'Seg. cte': segmentations_cte,
...
variables = {'Train travel time': TRAIN_TT_SCALED,
...
groupsOfVariables = {'Travel time': ['Train travel time',
                                     'Swissmetro travel time',
                                     'Car travel time'],
                     'Travel cost': ['Train travel cost',
...
nonlinearSpecs = {'Travel time': [mylog,
                                  sqrt,
                                  square,
                                  piecewise_time_1,
                                  piecewise_time_2,
...
utility_car = [('Car travel time', 'Seg. time', (None, 0), None),
               ('Car travel cost', 'Seg. cost', (None, 0), None)]


utilities = {1: ('train', utility_train),
             2: ('Swissmetro', utility_sm),
             3: ('car', utility_car)}

availabilities = {1: TRAIN_AV_SP,
                  2: SM_AV,
                  3: CAR_AV_SP}
...
theProblem = assisted.specificationProblem('Swissmetro',
                                           database,
                                           variables,
                                           groupsOfVariables,
                                           genericForbiden,
