...
all_segmentations = {'TripPurpose': (q02_TripPurpose, {1: 'business',
                                                       2: 'leisure',
                                                       3: 'attending conf.',
                                                       4: 'business & leisure',
                                                       0: 'unknown'}),
                     'Gender': (q17_Gender, {1: 'male',
                                             2: 'female',
                                            -1: 'unknown'}),
                     'Education': (q20_Education, {1: 'less than high school',
                                                   2: 'high school',
                                                   3: 'some college',
                                                   4: 'associate occ.',
                                                   5: 'associate acad.',
                                                   ...
                                                   9: 'doctorate',
                                                   -1: 'unkonown'}),
                     'Importance': (q11_DepartureOrArrivalIsImportant, {1: 'departure',
                                                                        2: 'arrival',
                                                                        3: 'not important'}),
                     'Who pays': (q03_WhoPays, {1: 'traveler',
                                                2: 'employer',
                                                3: 'third party',
                                                0: 'unknown'})}
...
groupsOfVariables = {'Fare': ['Fare direct',
                              'Fare same',
                              'Fare multiple'],
                     'Legroom': ['Legroom direct',
                                 'Legroom same',
                                 'Legroom multiple'],
                     'Time': ['Time direct',
                              'Time same',
...
nonlinearSpecs = {'Time': [mylog,
                           sqrt,
                           square,
                           boxcox_time,
                           piecewise_time_1,
                           piecewise_time_2],
                  'Fare': [ incomeInteraction,
                            incomeInteraction2,
...
utility_direct = [('Fare direct', 'Seg. fare', (None, 0), None),
...
utility_same = [(None, 'Seg. cte', (None, None), None),
...
utility_multiple = [(None, 'Seg. cte', (None, None), None),
...
utilities = {1: ('Non stop', utility_direct),
...
theProblem = assisted.specificationProblem('Airline',
                                           database,
                                           variables,
                                           groupsOfVariables,
                                           genericForbiden,
...
sg1 = {'Seg. cte': [],
       'Seg. legroom': ['TripPurpose', 'Gender']}

sg2 = {'Seg. cte': ['TripPurpose'],
       'Seg. legroom': ['Gender']}
