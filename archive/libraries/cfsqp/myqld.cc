...
#define dmin(a,b) (doublereal)patMin(a,b)
...
int ql0001_(int *m,int *me,int *mmax,int *n,int *nmax,int *mnn,
            patReal *c,patReal *d,patReal *a,patReal *b,patReal *xl,
            patReal *xu,patReal *x,patReal *u,int *iout,int *ifail,
            int *iprint,patReal *war,int *lwar,int *iwar,int *liwar,
            patReal *eps1)
#else
/* Subroutine */ 
