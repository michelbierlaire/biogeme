...
static patReal   *make_dv(int);
static patReal   **make_dm(int, int);
static void     free_iv(int *);
static void     free_dv(patReal *);
static void     free_dm(patReal **, int);
static patReal   *convert(patReal **, int, int);
#else
static int      *make_iv();
static patReal   *make_dv();
static patReal   **make_dm();
static void     free_iv();
static void     free_dv();
static void     free_dm();
static patReal   *convert();
#endif
...
#ifdef __STDC__
int
ql0001_(int *,int *,int *,int *,int *,int *,patReal *,patReal *,
        patReal *,patReal *,patReal *,patReal *,patReal *,patReal *,
        int *,int *,int *,patReal *,int *,int *,int *,patReal *);
static void     diagnl(int, patReal, patReal **);
static void     error(patString,int *);
static void
estlam(int,int,int *,patReal,patReal **,patReal *,patReal *,patReal *,
       struct _constraint *,patReal *,patReal *,patReal *,patReal *);
static patReal   *colvec(patReal **,int,int);
static patReal   scaprd(int,patReal *,patReal *);
static patReal   small(void);
static int      fuscmp(patReal,patReal);
static int      indexs(int,int);
static void     matrcp(int,patReal **,int,patReal **);
static void     matrvc(int,int,patReal **,patReal *,patReal *);
static void     nullvc(int,patReal *);
static void
resign(int,int,patReal *,patReal *,patReal *,struct _constraint *,
       patReal *,int,int);
static void     sbout1(FILE *,int,patString,patReal,patReal *,int,int);
static void     sbout2(FILE *,int,int,patString,patString,patReal *);
static void     shift(int,int,int *);
static patReal
slope(int,int,int,int,int,struct _objective *,patReal *,patReal *,
      patReal *,patReal,patReal,int,patReal *,int);
...
static void     error();
static void     estlam();
static patReal   *colvec();
static patReal   scaprd();
static patReal   small();
static int      fuscmp();
static int      indexs();
static void     matrcp();
static void     matrvc();
...
cfsqp1(int,int,int,int,int,int,int,int,int,int,int *,int,
       int,int,int,patReal,patReal,int *,int *,struct _parameter *,
...
initpt(int,int,int,int,int,int,int,struct _parameter *,
       struct _constraint *,void (*)(int,int,patReal *,patReal *,void *),
       void (*)(int,int,patReal *,patReal *,
                void (*)(int,int,patReal *,patReal *,void *),void *));
static void
dir(int,int,int,int,int,int,int,int,int,int,int,int,patReal *,
    patReal,patReal,patReal *,patReal *,patReal,patReal *,patReal *,int *,
    int *,int *,int *,int *,int *,struct _parameter *,patReal *,
    patReal *,struct _constraint *,struct _objective *,patReal *,
    patReal *,patReal *,patReal *,patReal *,patReal *,patReal **,patReal *,
    patReal *,patReal *,patReal *,patReal **,patReal **,patReal *,
    patReal *,struct _violation *,void (*)(int,int,patReal *,patReal *,
					  void *),void (*)(int,int,patReal *,patReal *,void *));
static void
step1(int,int,int,int,int,int,int,int,int,int,int,int *,int *,int *,
      int *,int *,int *,int *,int *,int,patReal,struct _objective *,
      patReal *,patReal *,patReal *,patReal *,patReal *,patReal *,patReal *,
      patReal *,patReal *,patReal *,patReal *,struct _constraint *,
      patReal *,patReal *,struct _violation *viol,
      void (*)(int,int,patReal *,patReal *,void *),
      void (*)(int,int,patReal *,patReal *,void *),void *);
static void
hessian(int,int,int,int,int,int,int,int,int,int,int,int *,int,
        patReal *,struct _parameter *,struct _objective *,
        patReal,patReal *,patReal *,patReal *,patReal *,patReal *,
        struct _constraint *,patReal *,int *,int *,patReal *,
        patReal *,patReal *,patReal **,patReal *,patReal,int *,
        patReal *,patReal *,void (*)(int,int,patReal *,patReal *,void *),
        void (*)(int,int,patReal *,patReal *,void *),
        void (*)(int,int,patReal *,patReal *,
                 void (*)(int,int,patReal *,patReal *,void *),void *),
        void (*)(int,int,patReal *,patReal *,
                 void (*)(int,int,patReal *,patReal *,void *),void *),
        patReal **,patReal *,patReal *,struct _violation *);
static void
...
update_omega(int,int,int,int *,int,int,int,int,patReal,patReal,
             struct _constraint *,struct _objective *,patReal *,
             struct _violation *,void (*)(int,int,patReal *,patReal *,
					  void *),void (*)(int,int,patReal *,patReal *,void *),
             void (*)(int,int,patReal *,patReal *,
		      void (*)(int,int,patReal *,patReal *,void *),void *),
             void (*)(int,int,patReal *,patReal *,
...
#ifdef __STDC__
static void
dealloc(int,int,patReal *,int *,int *,struct _constraint *cs,
	struct _parameter *);
#else
static void dealloc();
#endif
...
cfsqp(int nparam,int nf,int nfsr,int nineqn,int nineq,int neqn,
      ...
      int mode,int iprint,int miter,int *inform,patReal bigbnd,
      patReal eps,patReal epseqn,patReal udelta,patReal *bl,patReal *bu,
      patReal *x,patReal *f,patReal *g,patReal *lambda,
      void (*obj)(int, int, patReal *, patReal *,void *),
      void (*constr)(int,int,patReal *,patReal *,void *),
      void (*gradob)(int,int,patReal *,patReal *,
                     void (*)(int,int,patReal *,patReal *,void *),void *),
 ...
 *          inform=10:iterations interrupted by the user
 ...
 */
{
  ...
  patReal *signeq;
  patReal xi,gi,gmax,dummy,epskt;
 ...
 L605:
  ...
  if (nob==0) {
	...
	DETAILED_MESSAGE("constraints and linear equality constraints, ");
	DETAILED_MESSAGE("ncallg = " << setw(10) << glob_info.ncallg);
	if (ipp==0)
	  DETAILED_MESSAGE(" iteration           " << setw(26) << glob_prnt.iter);
	if (ipp>0)
	  DETAILED_MESSAGE(" iteration           " << setw(26) << glob_prnt.iter-1);
...
#ifdef __STDC__
static void
dealloc(int nineq,int neq,patReal *signeq,int *indxob,
...
#ifdef __STDC__
static void
dealloc1(int,int,patReal **,patReal **,patReal **,patReal *,patReal *,
         patReal *,patReal *,patReal *,patReal *,patReal *,patReal *,
         patReal *,patReal *,patReal *,patReal *,int *,int *,int *);
#else
...
cfsqp1(int miter,int nparam,int nob,int nobL,int nfsip,int nineqn,
       ...
       int nctotl,int nrowa,int feasb,patReal epskt,patReal epseqn,
       int *indxob,int *indxcn,struct _parameter *param,
       struct _constraint *cs, struct _objective *ob,
       patReal *signeq,void (*obj)(int,int,patReal *,patReal *,void *),
       void (*constr)(int,int,patReal *,patReal *,void *),
       void (*gradob)(int,int,patReal *,patReal *,
		      void (*)(int,int,patReal *,patReal *,void *),void *),
       void (*gradcn)(int,int,patReal *,patReal *,
...
#endif
{
  ...
  patReal Cbar,Ck,dbar,fmax,fM,fMp,steps,d0nm,dummy,
    sktnom,scvneq,grdftd,psf;
  patReal *di,*d,*gm,*grdpsf,*penp,*bl,*bu,*clamda,
    *cvec,*psmu,*span,*backup;
  patReal **hess,**hess1,**a;
  patReal *tempv;
...
#ifdef __STDC__
static void
dealloc1(int nparam,int nrowa,patReal **a,patReal **hess,patReal **hess1,
         patReal *di,patReal *d,patReal *gm,patReal *grdpsf,patReal *penp,
         patReal *bl,patReal *bu,patReal *clamda,patReal *cvec,patReal *psmu,
         patReal *span,patReal *backup,int *iact,int *iskip,int *istore)
#else
  static void
dealloc1(nparam,nrowa,a,hess,hess1,di,d,gm,grdpsf,penp,bl,bu,clamda,
         cvec,psmu,span,backup,iact,iskip,istore)
  int     nparam,nrowa;
patReal  **a,**hess,**hess1;
patReal  *di,*d,*gm,*grdpsf,*penp,*bl,*bu,*clamda,*cvec,*psmu,*span,
  *backup;
int     *iact,*iskip,*istore;
#endif
{
...
check(int nparam,int nf,int nfsip,int *Linfty,int nineq,
      ...
      int *modem,patReal eps,patReal bigbnd,struct _parameter *param)
#else
  static void
...
#endif
{
  ...
  if (eps<=glob_grd.epsmac) {
    error("eps should be bigger than epsmac!         ",
	  &glob_prnt.info);
    DETAILED_MESSAGE("epsmac = " << setw(22) << setprecision(14) 
...
#endif
{
  ...
  patReal x0i,*atemp,*htemp;
  patReal *x,*bl,*bu,*cvec,*clamda,*bj;
  patReal **a,**hess;
...
update_omega(int nparam,int ncsipl,int ncsipn,int *mesh_pts,
	     int nineqn,int nob,int nobL,int nfsip,patReal steps,
	     patReal fmax,struct _constraint *cs,struct _objective *ob,
	     patReal *x,struct _violation *viol,
	     void (*constr)(int,int,patReal *,patReal *,void *),
	     void (*obj)(int,int,patReal *,patReal *,void *),
	     void (*gradob)(int,int,patReal *,patReal *,
			    void (*)(int,int,patReal *,patReal *,void *),void *),
...
#endif
{
  ...
  patReal epsilon,g_max,fprev,fnow,fnext,fmult;
  ...
  if (glob_prnt.iprint>=2 && display)
    DETAILED_MESSAGE(" |Xi_k| for g       " << setw(22) 
		     << setprecision(14) 
		     << setiosflags(ios::scientific|ios::showpos) 
		     << glob_info.tot_actg_sip);
  ...
  if (nfsip) {
    ...
    if (glob_prnt.iprint>=2 && display)
      DETAILED_MESSAGE(" |Omega_k| for f    " << setw(26) <<
		       glob_info.tot_actf_sip);
  }
  viol->type=NONE;
  viol->index=0;
...
dqp(int,int,int,int,int,int,int,int,int,int,int,int,int,
    int,int,int *,struct _parameter *,patReal *,int,
    struct _objective *,patReal,patReal *,struct _constraint *,
    patReal **,patReal *,patReal *,patReal *,patReal *,
    patReal **,patReal **,patReal *,patReal,int);
static void
di1(int,int,int,int,int,int,int,int,int,int,int,int,int *,
    int,struct _parameter *,patReal *,struct _objective *,
    patReal,patReal *,struct _constraint *,patReal *,
    patReal *,patReal *,patReal *,patReal **,patReal *,patReal);
#else
static void dqp();
static void di1();
...
dir(int nparam,int nob,int nobL,int nfsip,int nineqn,int neq,int neqn,
    ...
    int feasb,patReal *steps,patReal epskt,patReal epseqn,
    patReal *sktnom,patReal *scvneq,patReal Ck,patReal *d0nm,
    patReal *grdftd,int *indxob,int *indxcn,int *iact,int *iskp,
    int *iskip,int *istore,struct _parameter *param,patReal *di,
    patReal *d,struct _constraint *cs,struct _objective *ob,
    patReal *fM,patReal *fMp,patReal *fmax,patReal *psf,patReal *grdpsf,
    patReal *penp,patReal **a,patReal *bl,patReal *bu,patReal *clamda,
    patReal *cvec,patReal **hess,patReal **hess1,
    patReal *backup,patReal *signeq,struct _violation *viol,
    void (*obj)(int,int,patReal *,patReal *,void *),
    void (*constr)(int,int,patReal *,patReal *,void *))
#else
  static void
...
patReal  *steps,epskt,epseqn,*sktnom,Ck,*d0nm,*grdftd,*fM,*fMp,
  *fmax,*psf,*scvneq;
patReal  *di,*d,*grdpsf,*penp,**a,*bl,*bu,*clamda,*cvec,**hess,
  **hess1,*backup,*signeq;
struct  _constraint *cs;
struct  _objective  *ob;
struct  _parameter  *param;
...
#endif
{
  ...
  patReal fmxl,vv,dx,dmx,dnm1,dnm,v0,v1,vk,temp1,temp2,theta,
  ...
  *sktnom=sqrt(scaprd(nparam,w,w));
  if (((*d0nm<=epskt)||((gLgeps>0.e0)&&(*sktnom<=gLgeps)))&&
    ...
    sbout1(glob_prnt.io,nparam,"multipliers for x   ",dummy,
	   param->mult,2,2);
    if (ncnstr!=0) {
      DETAILED_MESSAGE("\t\t\t            for g    \t "<< setw(22) << setprecision(14) 
		       << setiosflags(ios::scientific|ios::showpos) 
		       << cs[1].mult);
      for (j=2; j<=ncnstr; j++)
	DETAILED_MESSAGE(" \t\t\t\t\t\t " << setw(22) 
			 << setprecision(14) 
			 << setiosflags(ios::scientific|ios::showpos) 
			 << cs[j].mult);
    }
...
dqp(int nparam,int nqpram,int nob,int nobL,int nfsip,int nineqn,
    ...
    struct _parameter *param,patReal *di,int feasb,struct _objective *ob,
    patReal fmax,patReal *grdpsf,struct _constraint *cs,
    patReal **a,patReal *cvec,patReal *bl,patReal *bu,patReal *clamda,
    patReal **hess,patReal **hess1,patReal *x,
    patReal vv,int job)
#else
  static void
...
patReal  fmax,vv;
patReal  *di,*grdpsf,**a,*cvec,*bl,*bu,*clamda,**hess,**hess1,*x;
struct  _constraint *cs;
struct  _objective  *ob;
struct  _parameter  *param;
#endif
{
  int i,ii,j,jj,ij,k,iout,mnn,nqnp,zero,temp1,temp2,ncnstr_used,
    numf_used;
  int *iw_hold;
  patReal x0i,xdi,*bj,*htemp,*atemp;
...
di1(int nparam,int nqpram,int nob,int nobL,int nfsip,int nineqn,
    ...
    patReal *d0,struct _objective *ob,patReal fmax,patReal
    *grdpsf,struct _constraint *cs,patReal *cvec,patReal *bl,patReal *bu,
    patReal *clamda,patReal **hess1,patReal *x,patReal steps)
#else
  static void
...
patReal  fmax,steps;
patReal  *d0,*grdpsf,*cvec,*bl,*bu,*clamda,**hess1,*x;
struct _constraint *cs;
struct _objective  *ob;
struct _parameter  *param;
#endif
{
  ...
  int *iw_hold;
  patReal x0i,eta,*atemp,*htemp,**a,*bj;
...
step1(int nparam,int nob,int nobL,int nfsip,int nineqn,int neq,int neqn,
      ...
      int *istore,int feasb,patReal grdftd,struct _objective *ob,
      patReal *fM,patReal *fMp,patReal *fmax,patReal *psf,patReal *penp,
      patReal *steps,patReal *scvneq,patReal *xnew,patReal *x,patReal *di,
      patReal *d,struct _constraint *cs,patReal *backup,patReal *signeq,
      struct _violation *sip_viol,
      void (*obj)(int,int,patReal *,patReal *,void *),
      void (*constr)(int,int,patReal *,patReal *,void *),void *cd)
#else
  static void
step1(nparam,nob,nobL,nfsip,nineqn,neq,neqn,nn,ncsipl,ncsipn,ncnstr,
  ...
  *ncg,*ncf,feasb,*iskp;
int     *indxob,*indxcn,*iact,*iskip,*istore;
patReal  grdftd,*fM,*fMp,*fmax,*steps,*scvneq,*psf;
patReal  *xnew,*x,*di,*d,*penp,*backup,*signeq;
struct  _constraint *cs;
struct  _objective  *ob;
struct  _violation  *sip_viol;
void    (* obj)(),(* constr)();
...
#endif
{
  ...
  patReal prod1,prod,dummy,fmax1,tolfe,ostep,temp,**adummy,fii;
  ...
  for (;;) {
    reform=TRUE;
    if (glob_prnt.iprint >= 3 && display)
      DETAILED_MESSAGE("\t\t\t trial number            " << setw(22) << itry);
    prod=prod1*(*steps);
...
hessian(int nparam,int nob,int nfsip,int nobL,int nineqn,int neq,
	...
	int feasb,patReal *xnew,struct _parameter *param,
	struct _objective *ob,patReal fmax,patReal *fM,patReal *fMp,
	patReal *psf,patReal *grdpsf,patReal *penp,struct _constraint *cs,
	patReal *gm,int *indxob,int *indxcn,patReal *delta,patReal *eta,
	patReal *gamma,patReal **hess,patReal *hd,patReal steps,int *nrst,
	patReal *signeq,patReal *span,
	void (*obj)(int,int,patReal *,patReal *,void *),
	void (*constr)(int,int,patReal *,patReal *,void *),
	void (*gradob)(int,int,patReal *,patReal *,
		       void (*)(int,int,patReal *,patReal *,void *),void *),
	void (*gradcn)(int,int,patReal *,patReal *,
		       void (*)(int,int,patReal *,patReal *,void *),void *),
	patReal **phess,patReal *psb,patReal *psmu,
	struct _violation *sip_viol)
#else
  static void
...
int     *indxob,*indxcn;
patReal  steps,*psf,fmax,*fM,*fMp;
patReal  *xnew,*grdpsf,*penp,*gm,*delta,*eta,*gamma,
...
#endif
{
  ...
  patReal dhd,gammd,etad,dummy,theta,signgj,psfnew,delta_s;
  patReal *tempv;
  ...
  if (ncnstr != 0) {
    DETAILED_MESSAGE("\t\t\t             for g   \t "
		     ...
		     << cs[1].mult);
    for (j=2; j<=ncnstr; j++)
      DETAILED_MESSAGE(" \t\t\t\t\t\t " << setw(22) << setprecision(14) 
		       << setiosflags(ios::scientific|ios::showpos) 
		       << cs[j].mult);
  }
  if (nobL > 1) {
...
out(int miter,int nparam,int nob,int nobL,int nfsip,int ncn,
    ...
    int *mesh_pts,patReal *x,struct _constraint *cs,
...
#endif
{
  ...
  patReal SNECV,dummy,*adummy,gmax;
  ...
  if (glob_prnt.iprint==1 && nstop!=0) {
	...
	if (nob==nobL) {
	  GENERAL_MESSAGE(" \t\t\t " << setw(22) << setprecision(14) 
			  << setiosflags(ios::scientific|ios::showpos) 
			  << ob[i].val);
	}
	else {
	...
	for (i=1; i<=glob_info.ncsipl; i++) {
	  ...
	  DETAILED_MESSAGE(" \t\t\t " << setw(22) << setw(22) << setprecision(14) 
			   << setiosflags(ios::scientific|ios::showpos) 
			   << setprecision(14) 
			   << setiosflags(ios::scientific|ios::showpos) 
			   << gmax);
  ...
  if (glob_prnt.iprint<=2 && nstop==0)
    DETAILED_MESSAGE(" inform              " << setw(26) << glob_prnt.info);
  if (glob_prnt.iprint==1 && nstop==0 && (ncsipl+ncsipn)!=0)
    DETAILED_MESSAGE(" |Xi_k|              " << setw(26) << glob_info.tot_actg_sip);
  if (glob_prnt.iprint==1 && nstop==0 && nfsip!=0)
    DETAILED_MESSAGE(" |Omega_k|           " << setw(26) <<
		     glob_info.tot_actf_sip);
  glob_prnt.iter++;
  ...
  if (glob_prnt.initvl==0 && feasb && display)
    DETAILED_MESSAGE(" ncallf              " << setw(26) <<
		     glob_info.ncallf);
  if (glob_prnt.initvl==0 && (nn!=0 || !feasb) && display)
    DETAILED_MESSAGE(" ncallg              " << setw(26) <<
		     glob_info.ncallg);
  if (glob_prnt.iprint>=3 && glob_prnt.iter_mod!=1 && nstop!=0
      && !(glob_prnt.iter%glob_prnt.iter_mod))
    DETAILED_MESSAGE("\n The following was calculated during iteration "<<setw(5) << glob_prnt.iter <<":") ;
 ...
 L120:
  ...
  if (glob_prnt.iprint>=3)
    DETAILED_MESSAGE(" inform              "<< setw(26) <<
		     glob_prnt.info);
...
#ifdef __STDC__
void grobfd(int nparam,int j,patReal *x,patReal *gradf,
            void (*obj)(int,int,patReal *,patReal *,void *),void *cd)
#else
...
#endif
{
  ...
  for (i=0; i<=nparam-1; i++) {
    ...
    if (!(glob_prnt.ipd==1 || j != 1 || glob_prnt.iprint<3)) {
      ...
      if (i==0) DETAILED_MESSAGE("\tdelta(i)\t " << setw(22) << setprecision(14) 
				 << setiosflags(ios::scientific|ios::showpos) 
				 << delta);
      if (i!=0) DETAILED_MESSAGE("\t\t\t " << setw(22) << setprecision(14) 
				 << setiosflags(ios::scientific|ios::showpos) 
				 << delta);
    }
    x[i]=xi+delta;
...
#ifdef __STDC__
void grcnfd(int nparam,int j,patReal *x,patReal *gradg,
            void (*constr)(int,int,patReal *,patReal *,void *),void *cd)
#else
...
#ifdef __STDC__
static void fool(patReal, patReal, patReal *);
#else
static void fool();
#endif
...
#ifdef __STDC__
static void diagnl(int nrowa,patReal diag,patReal **a)
#else
...
#ifdef __STDC__
static void error(patString string,int *inform)
#else
...
#ifdef __STDC__
static void
estlam(int nparam,int neqn,int *ifail,patReal bigbnd,patReal **hess,
       patReal *cvec,patReal *a,patReal *b,struct _constraint *cs,
       patReal *psb,patReal *bl,patReal *bu,patReal *x)
#else
  static void
estlam(nparam,neqn,ifail,bigbnd,hess,cvec,a,b,cs,psb,bl,bu,x)
  int nparam,neqn,*ifail;
patReal bigbnd,**hess,*cvec,*a,*b,*psb,*bl,*bu,*x;
struct _constraint *cs;
#endif
{
...
#ifdef __STDC__
static patReal *colvec(patReal **a,int col,int nrows)
#else
  static patReal *colvec(a,col,nrows)
  patReal **a;
int col,nrows;
#endif
{
...
#ifdef __STDC__
static patReal scaprd(int n,patReal *x,patReal *y)
#else
  static patReal scaprd(n,x,y)
  patReal *x, *y;
int n;
#endif
{
...
#ifdef __STDC__
static void fool(patReal x,patReal y,patReal *z)
#else
...
#ifdef __STDC__
static int fuscmp(patReal val,patReal thrshd)
#else
...
#ifdef __STDC__
static void matrcp(int ndima,patReal **a,int ndimb,patReal **b)
#else
...
#ifdef __STDC__
static void matrvc(int la,int na,patReal **a,patReal *x,patReal *y)
#else
...
#ifdef __STDC__
static void nullvc(int nparam,patReal *x)
#else
...
#ifdef __STDC__
static void
resign(int n,int neqn,patReal *psf,patReal *grdpsf,patReal *penp,
       struct _constraint *cs,patReal *signeq,int job1,int job2)
#else
  static void
resign(n,neqn,psf,grdpsf,penp,cs,signeq,job1,job2)
  int job1,job2,n,neqn;
patReal *psf,*grdpsf,*penp,*signeq;
struct _constraint *cs;
#endif
{
  int i,j,nineq;
...
#ifdef __STDC__
static void
sbout1(FILE *io,int n, patString s1,patReal z,patReal *z1,int job,int level)
#else
...
#endif
{
  ...
  if (job != 2) {
    if (level == 1) {
      DETAILED_MESSAGE(" " << s1 << "    " << setw(22) << setprecision(14) 
		       << setiosflags(ios::scientific|ios::showpos) 
		       << z) ;
    }
    if (level == 2) {
      DETAILED_MESSAGE("\t\t\t" << s1 << setw(22) << setprecision(14) 
		       << setiosflags(ios::scientific|ios::showpos)<< z) ;
    }
    return;
  }
  if (n==0) return;
  if (level == 1) {
    DETAILED_MESSAGE(" "<<s1<<"\t " << setw(22) << setprecision(14) 
		     << setiosflags(ios::scientific|ios::showpos)<< z1[1]) ;
  }
  if (level == 2) {
    DETAILED_MESSAGE("\t\t\t "<<s1<< setw(22) << setprecision(14) 
		     << setiosflags(ios::scientific|ios::showpos)<< z1[1]) ;
  ...
  for (j=2; j<=n; j++) {
    if (level == 1) {
      DETAILED_MESSAGE(" \t\t\t " << setw(22) << setprecision(14) 
		       << setiosflags(ios::scientific|ios::showpos)<< z1[j]) ;
    }
    if (level == 2) {
      DETAILED_MESSAGE("\t\t\t\t\t\t " << setw(22) << setprecision(14) 
		       << setiosflags(ios::scientific|ios::showpos)<< z1[j]) ;
...
#ifdef __STDC__
static void
sbout2(FILE *io,int n,int i,patString s1,patString s2,patReal *z)
#else
...
#endif
{
  ...
  DEBUG_MESSAGE("sbout2") ;

  DETAILED_MESSAGE("\t\t\t" << setw(8) << s1 << ' ' 
		   << setw(5) << i <<  ' ' 
		   << setw(1) << s2 << ' ' 
		   << setw(22) << setprecision(14) 
		   << setiosflags(ios::scientific|ios::showpos) << z[1]) ;
  for (j=2; j<=n; j++)
    DETAILED_MESSAGE("\t\t\t\t\t\t"
		     << setw(22) << setprecision(14) 
		     << setiosflags(ios::scientific|ios::showpos) << z[j]) ;
  return;
}
...
slope(int nob,int nobL,int neqn,int nparam,int feasb,
      struct _objective *ob,patReal *grdpsf,patReal *x,patReal *y,
      patReal fmax,patReal theta,int job,patReal *prev,int old)
#else
  static patReal
...
patReal fmax, theta;
patReal *grdpsf,*x,*y,* prev;
struct _objective *ob;
#endif
{
  int i;
  patReal slope1,rhs,rhog,grdftx,grdfty,diff,grpstx,grpsty;
  patReal tslope;
...
/*************************************************************/
/*     Create patReal precision vector                        */
/*************************************************************/
...
#endif
{
  ...
  if (!len) len=1;
  v=(patReal *)calloc(len,sizeof(patReal));
  if (!v) {
...
/*************************************************************/
/*     Create a patReal precision matrix                      */
/*************************************************************/
...
#endif
{
  ...
  if (rows == 0) rows=1;
  if (cols == 0) cols=1;
  temp=(patReal **)calloc(rows,sizeof(patReal *));
  if (!temp) {
  ...
  temp--;
  for (i=1; i<=rows; i++) {
    temp[i]=(patReal *)calloc(cols,sizeof(patReal));
    if (!temp[i]) {
      FATAL("Run-time error in make_dm");
      exit(1);
    }
...
/*************************************************************/
/*     Free a patReal precision vector                        */
/*************************************************************/
...
/*************************************************************/
/*     Free a patReal precision matrix                        */
/*************************************************************/

#ifdef __STDC__
static void
free_dm(patReal **m,int rows)
#else
  static void
free_dm(m,rows)
  patReal **m;
