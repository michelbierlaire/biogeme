//-*-c++-*------------------------------------------------------------
//
// File name : patProbaProbitModel.h
// Author :    \URL[Michel Bierlaire]{http://roso.epfl.ch/mbi}
// Date :      Sun May 22 11:59:24 2005
//
//--------------------------------------------------------------------

#ifndef patProbaProbitModel_h
#define patProbaProbitModel_h
...
/**
   @doc Defines the probability model for binary probit model, based on the specification of the utility functions and a sample
   @author \URL[Michel Bierlaire]{http://roso.epfl.ch/mbi}, EPFL (  Sun May 22 11:59:24 2005)
 */

class patProbaProbitModel : public patProbaModel {

public:
  /**
     Sole constructor
   */
  patProbaProbitModel(patUtility* aUtility) ;
...
private :
  ...
  unsigned long i,k ;
  patReal proba ;
  patVariables utilDerivativesChosen ;
  patVariables utilDerivativesUnchosen ;
