//-*-c++-*------------------------------------------------------------
//
// File name : patProbaGevModel.h
// Author :    \URL[Michel Bierlaire]{http://rosowww.epfl.ch/mbi}
// Date :      Wed Jan 10 14:10:03 2001
//
//--------------------------------------------------------------------

#ifndef patProbaGevModel_h
#define patProbaGevModel_h
...
class patProbaGevModel : public patProbaModel {
...
public:
   ...
   */
  patProbaGevModel(patGEV* _gevFunction,patUtility* aUtility) ;
...
private :
  ...
  vector<unsigned long> corrBiasIndices ;
  ...
  patVariables V ;
  patVariables term ;
  patVariables termDeriv ;
  patVariables expV ;
  patVariables correctedExpV ;
  patReal maxUtility ;
  ...
  patReal deriv ;
  patVariables dgdAlpha ;
  //  patReal dDeltadAlpha ;
  
  patBoolean correctForSelectionBias ;
  unsigned long indexCorr ;
};
