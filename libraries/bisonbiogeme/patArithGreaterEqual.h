//-*-c++-*------------------------------------------------------------
//
// File name : patArithGreaterEqual.h
// Author :    \URL[Michel Bierlaire]{http://rosowww.epfl.ch/mbi}
// Date :      Fri Nov 24 09:25:07 2000
//
//--------------------------------------------------------------------

#ifndef patArithGreaterEqual_h
#define patArithGreaterEqual_h

#include "patArithNode.h"

/**
   @doc This class implements a node of the tree representing a comparison (>=) operation 
   @author \URL[Michel Bierlaire]{http://rosowww.epfl.ch/mbi}, EPFL (Fri Nov 24 09:25:07 2000)
*/

class patArithGreaterEqual : public patArithNode {

public:
  
  /**
   */
  patArithGreaterEqual(patArithNode* par,
		       patArithNode* left, 
		       patArithNode* right) ;
  
  /**
   */
  ~patArithGreaterEqual() ;
   ...
   */
  virtual patArithGreaterEqual* getDeepCopy(patError*& err) ;
  /**
   */
