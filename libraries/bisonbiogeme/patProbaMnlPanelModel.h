//-*-c++-*------------------------------------------------------------
//
// File name : patProbaMnlPanelModel.h
// Author :    \URL[Michel Bierlaire]{http://roso.epfl.ch/mbi}
// Date :      Tue Mar 30 14:17:24 2004
//
//--------------------------------------------------------------------

#ifndef patProbaMnlPanelModel_h
#define patProbaMnlPanelModel_h
...
/**
   @doc Defines the probability model for multinomial logit model, based on the specification of the utility functions and a sample with panel data
   @author \URL[Michel Bierlaire]{http://roso.epfl.ch/mbi}, EPFL (Tue Mar 30 14:17:24 2004 )
 */

class patProbaMnlPanelModel : public patProbaPanelModel {

public:
  /**
     Sole constructor
  */
  patProbaMnlPanelModel(patUtility* aUtility) ;
  
  /**
     Destructor
  */
  ~patProbaMnlPanelModel() ;
