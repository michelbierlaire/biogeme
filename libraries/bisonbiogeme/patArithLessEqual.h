//-*-c++-*------------------------------------------------------------
//
// File name : patArithLessEqual.h
// Author :    \URL[Michel Bierlaire]{http://rosowww.epfl.ch/mbi}
// Date :      Fri Nov 24 09:20:17 2000
//
//--------------------------------------------------------------------

#ifndef patArithLessEqual_h
#define patArithLessEqual_h

#include "patArithNode.h"

/**
   @doc This class implements a node of the tree representing a comparison (<=) operation 
   @author \URL[Michel Bierlaire]{http://rosowww.epfl.ch/mbi}, EPFL (Fri Nov 24 09:20:17 2000)
*/

class patArithLessEqual : public patArithNode {

public:
  
  /**
   */
  patArithLessEqual(patArithNode* par,
		 patArithNode* left, 
		 patArithNode* right) ;
   ...
   */
  virtual patArithLessEqual* getDeepCopy(patError*& err) ;
  /**
   */
